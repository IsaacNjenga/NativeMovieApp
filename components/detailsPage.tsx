...
import { Main, ScrollView, Image, H1, YStack, Text, Paragraph } from 'tamagui';
      ...
      <ScrollView>
        ...
        <YStack
          ...
          <H1 color={'$blue7'}>
            ...
            <Text color={'$blue7'}>({new Date(movieQuery.data?.release_date || movieQuery.data?.first_air_date).getFullYear()})</Text>
          </H1>
